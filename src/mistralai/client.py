...
class MistralClient(ClientBase):
    ...
    def completion(
        ...
        """
        request = self._make_completion_request(prompt, model, suffix, temperature, max_tokens, top_p, random_seed)
    ...
    def completion_stream(
        ...
        request = self._make_completion_request(
            prompt, model, suffix, temperature, max_tokens, top_p, random_seed, stream=True
        )
